   ...
   # Initialize the model and optimizer
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), f"/home/ndelafuente/CVC/EGD_Barcelona/gastroscopy_attention_classifier/TRAIN&MODEL_4_GENERATEDDATA/kfold_weights_k4/model_fold_{fold}.pth")
        ...
        # Calculate and print per-class accuracy, recall, precision, and f1-score
        class_recalls = []  # to store recall for each class
        ...
        for i in range(num_classes):
            ...
            class_recalls.append(recall)  # Append the recall for this class to the list
        ...
        global_recall = np.mean(class_recalls)  # Average the per-class recalls for global recall

        # Add global metrics to class_metrics dictionary
